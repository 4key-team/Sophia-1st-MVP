...
class Settings:
    ...
    # Mem0 Memory (Task #42597)
    MEM0_ENABLED: bool = os.getenv("MEM0_ENABLED", "true").lower() == "true"
    MEM0_TOP_K: int = int(os.getenv("MEM0_TOP_K", "5"))
    MEM0_SIMILARITY_THRESHOLD: float = float(os.getenv("MEM0_SIMILARITY_THRESHOLD", "0.7"))
    MEM0_EMBEDDING_MODEL: str = os.getenv("MEM0_EMBEDDING_MODEL", "sentence-transformers/all-MiniLM-L6-v2")
